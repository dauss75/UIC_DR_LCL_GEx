...
library(qqplot2)
chr14.variant.rs1122361<-data.frame(chr14.variant["rs1122361",])
qplot(t(chr14.variant.rs1122361),t(IFI27L1.lymphocyte.exprs),col=sampleid$type)

chr14.variant.rs12587898<-data.frame(chr14.variant["rs12587898",])
qplot(t(chr14.variant.rs12587898),t(IFI27L1.lymphocyte.exprs),col=sampleid$type)

chr14.variant.rs748762<-data.frame(chr14.variant["rs748762",])
qplot(t(chr14.variant.rs748762),t(IFI27L1.lymphocyte.exprs),col=sampleid$type)

chr14.variant.rs3814821<-data.frame(chr14.variant["rs3814821",])
...
IFI27L1.PDR_nPDR.exprs<-IFI27L1.PDR_nPDR.exprs[,rownames(sampleid)]
colnames(IFI27L1.PDR_nPDR.exprs)<-sampleid$GWAS_ID
cor(t(chr14.variant.rs1122361),t(IFI27L1.PDR_nPDR.exprs))

setEPS()
postscript(file = "/Users/sjung/Project/GlobusGenomics/UIC/predixcan/edic_run/rs1122361.eps")
qplot(t(chr14.variant.rs1122361),t(IFI27L1.PDR_nPDR.exprs),col=sampleid$type, main="IFI27L1 vs rs11222361", ylab="Gene Expression (RG_PDR_nPDR)", xlab="Imputed genotype (rs1122361)") +labs(col='Group') +theme(plot.title = element_text(hjust = 0.5))
dev.off()

setEPS()
postscript(file = "/Users/sjung/Project/GlobusGenomics/UIC/predixcan/edic_run/rs12587898.eps")
qplot(t(chr14.variant.rs12587898),t(IFI27L1.PDR_nPDR.exprs),col=sampleid$type, main="IFI27L1 vs rs12587898", ylab="Gene Expression (RG_PDR_nPDR)", xlab="Imputed genotype (rs12587898)") +labs(col='Group') +theme(plot.title = element_text(hjust = 0.5))
dev.off()

setEPS()
postscript(file = "/Users/sjung/Project/GlobusGenomics/UIC/predixcan/edic_run/rs748762.eps")
qplot(t(chr14.variant.rs748762),t(IFI27L1.PDR_nPDR.exprs),col=sampleid$type, main="IFI27L1 vs rs748762", ylab="Gene Expression (RG_PDR_nPDR)", xlab="Imputed genotype (rs748762)") +labs(col='Group') +theme(plot.title = element_text(hjust = 0.5))
dev.off()

setEPS()
postscript(file = "/Users/sjung/Project/GlobusGenomics/UIC/predixcan/edic_run/rs3814821.eps")
qplot(t(chr14.variant.rs3814821),t(IFI27L1.PDR_nPDR.exprs),col=sampleid$type, main="IFI27L1 vs rs3814821", ylab="Gene Expression (RG_PDR_nPDR)", xlab="Imputed genotype (rs3814821)") +labs(col='Group') +theme(plot.title = element_text(hjust = 0.5))
dev.off()
